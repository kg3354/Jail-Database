...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2024 at 07:49 AM
...
-- Database: `jail`
--
CREATE DATABASE IF NOT EXISTS `jail` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `jail`;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `change_criminal_v_status` (`iCriminal_ID` DECIMAL(6,0), `iStatus` CHAR(1))   BEGIN
    IF (iStatus IN ('N', 'Y')) THEN
        ...
        WHERE Criminal_ID = iCriminal_ID;
        SELECT ROW_COUNT() as rows_affected;  -- This will show how many rows were updated
    END IF;
END$$
...
(70001, 123340008, '2023-05-02', '2023-06-02', 'P'),
(70002, 123340002, '2023-06-01', '2023-07-01', 'P'),
(70003, 123340001, '2023-07-01', '2023-08-01', 'P'),
(70004, 123340002, '2023-08-01', '2023-09-01', 'P'),
(70005, 123340005, '2023-08-11', '2023-09-11', 'P'),
(70006, 123340005, '2023-09-01', '2023-10-01', 'P'),
(70007, 123340003, '2023-10-01', '2023-11-01', 'P'),
(70008, 123340008, '2024-01-01', '2024-02-01', 'P'),
(70009, 123340010, '2024-02-01', '2024-03-01', 'P'),
(70010, 123340009, '2024-03-01', '2024-04-01', 'P');
...
(123340011, 100008, 'U', '2024-04-01', 'CL', '2024-04-08', '2024-04-11'),
(123340012, 100001, 'M', '2024-04-24', 'CA', '2024-04-25', '2024-04-30');
...
(100012, 'Guo', 'Tom', '6401 wooded view dr', 'Hudson', 'OH', '44236', '3305248078', 'N', 'N');
...
(90000011, 'Guo', 'Tom', '123', '404012', '1233233333', 'I');
...
(1, 'admin', '$2b$12$oUYLTP80z5CuKTJgEkQl7.vG2n/ePadsMCI.1pnOqmk8.GrhkpA.G', 'w'),
(2, 'user', '$2b$12$EXG8oujfhigyrAVgkjOkwODDZFBxD3MCZwlP8hXwafqYItfxNu8aa', 'r'),
(3, 'test4', '$2b$12$9FVEfJTRCV/xMHAzCGXZmOj/AoQxNdQHNwspFVwIc9z8GxhO4jeHi', 'r'),
(5, 'test', '$2b$12$ETDRXZEUD1aRy8/qzDUVHenZYXKpNzf9qnVGziQzY10HZVPn0pjC.', 'r');
...
CREATE ROLE IF NOT EXISTS 'DeveloperRole';
