create table Criminals(
    ...
    CHECK (V_status = 'Y' OR V_status = 'N'),
    CHECK (P_status = 'Y' OR P_status = 'N')
);
...
create table Crimes(
    ...
    CHECK (Classification IN ('F', 'M', 'O', 'U')),
